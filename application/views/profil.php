              ...
              <div class="tab-pane fade show active" id="pills-breakfast" role="tabpanel" aria-labelledby="pills-breakfast-tab">
                <div class="row">
                  <div class="col-md-6 site-animate">
                    ...
                    <div class="media menu-item">
                      <img class="mr-3" src="<?php echo base_url('assets/images/menu_2.jpg')?>" class="img-fluid" alt="Free Template by colorlib.com">
                      <div class="media-body">
                    ...
                    <div class="media menu-item">
                      <img class="mr-3" src="<?php echo base_url('assets/images/menu_3.jpg')?>" class="img-fluid" alt="Free Template by colorlib.com">
                      <div class="media-body">
